...
def detect_poses(keypoints):
    ...
    thershold_bt_shoulders = (keypoints[LEFT_SHOULDER][0] - keypoints[RIGHT_SHOULDER][0])//3
    thershold_vertical = (keypoints[NOSE][1] - keypoints[LEFT_EYE][1])*2
    ...
    if (is_above(keypoints[RIGHT_WRIST], keypoints[RIGHT_SHOULDER]) and 
        ...
        is_left_of(keypoints[RIGHT_WRIST], keypoints[RIGHT_SHOULDER], thershold_bt_shoulders) and 
