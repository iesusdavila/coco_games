...
def detect_poses(keypoints):
    ...
    thershold_touch_shoulder = (keypoints[NOSE][1] - keypoints[LEFT_EYE][1])*2
    if is_near(keypoints[LEFT_WRIST], keypoints[LEFT_SHOULDER], thershold_touch_shoulder):
        poses.append("Tocando hombro izquierdo con mano izquierda")
    
    if is_near(keypoints[RIGHT_WRIST], keypoints[LEFT_SHOULDER], thershold_touch_shoulder):
        poses.append("Tocando hombro izquierdo con mano derecha")
    
    if is_near(keypoints[RIGHT_WRIST], keypoints[RIGHT_SHOULDER], thershold_touch_shoulder):
